...
class AsyncConsumer(object):
    ...
    def __init__(self, amqp_url, on_message):
    ...
    def setup_queue(self, queue_name):
        ...
        self._channel.queue_declare(queue=queue_name, durable=True, callback=cb, arguments={"x-message-ttl": 3600000})
...
class ReconnectingAsyncConsumer(object):
    ...
    def __init__(self, amqp_url, on_message):
        ...
        self._on_message = on_message
        self._consumer = AsyncConsumer(self._amqp_url, self._on_message)
